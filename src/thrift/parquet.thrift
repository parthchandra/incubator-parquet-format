...
struct SchemaElement {
  ...
  /** Used when this column contains timestamps that are specific to
   * a particular timezone for an entire column.  Can be paired with
   * TIMESTAMP type.
   */
  9: optional tz.TimeZone time_zone;
}
